...
ApplicationWindow {
    ...
    SerialHandler {
        ...
        onDftCalculated: dftChart.updateData(dftData)
        onDigitalInputsChanged: digitalInputs = inputs
        onConnectionChanged: isConnected = connected
        onStatusChanged: statusMessage = message
    }
        ...
        Item {
            ColumnLayout {
                ...
                ScopeChart {
                    ...
                    showTriggerLine: showTriggerLine
                }
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            ComboBox {
                ...
                onActivated: serialHandler.connectToPort(currentText)
            }
    ...
    // File Dialog for Arbitrary Waveform
    FileDialog {
        id: fileDialog
        ...
        onAccepted: {
            ...
            // TODO: Implement waveform loading
